...
📍*¿Qué es el MAC?*
El Mantenimiento de Aulas Computarizadas (o mejor conocido por sus siglas: MAC) es el grupo de preparadores de apoyo del laboratorio F de la Universidad Simón Bolívar. Nuestra principal función es el cuidado y mantenimiento de los laboratorios de planta baja y piso 1 del edificio MYS. Nos caracterizamos por ser un grupo unido, con mucha mística y trabajo en equipo, apasionados por las nuevas tecnologías y principalmente la administración de sistemas operativos. ¡El MAC es el lugar ideal para crecer en la carrera, conocer nuevas personas y aprender un sin fin de cosas nuevas! 👌

📍*¿Cuál es la estructura del MAC?*
La estructura del MAC es lineal, todos los preparadores tenemos el mismo rango. Sin embargo, tenemos un jefe quién es el encargado de representar al MAC ante las autoridades de la universidad y profesores, además de ser el coordinador de nuestras actividades internas.
