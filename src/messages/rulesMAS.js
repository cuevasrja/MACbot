...
> A cada *participante* seleccionado se le dará una lista con 3 opciones de integrantes del otro *equipo* y deberá elegir uno de ellos para intentar adivinar si él es su **MACamigo Secreto**.

> La *vidente* contestará si el *participante* acertó la adivinanza o no. Pero cuidado, la *vidente* no te lo pondrá fácil, así que hay cierta probabilidad de que dé un falso positivo. De esta manera, los *participantes* sólo pueden estar seguros si la respuesta fue negativa.
...
> El *alcalde* seleccionará de forma aleatoria (sin reemplazo, hasta pasar por todos los integrantes) un integrante del *equipo* que le toque adivinar.

> El *participante* seleccionará el nombre de quién cree que le ofrenda a él, de una lista de nombres de los integrantes del otro *equipo*.

> El *alcalde* dirá si acertó o no, y sumará el puntaje.

> Se continúa con el siguiente *participante*.

> Las celebraciones terminan cuando todos hayan adivinado o, en el peor de los casos, cuando todos los integrantes de un *equipo* hayan sido devorados o linchados, y se anuncia el *equipo ganador*, aquel que tuvo el *menor puntaje*.
`
